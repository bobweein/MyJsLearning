...
//   const arrJcor = arrJ.slice(1, -1);

//   const Uniarr = arrJcor.concat(arrK);

//   Uniarr.forEach(function (element, index) {
//     if (element >= 3) {
//       console.log(
...
//   const ageAverage = adultDog.reduce(
...
// humanage = calcAverageHumanAge([16, 6, 10, 5, 6, 1, 4]);
// console.log(humanage);
