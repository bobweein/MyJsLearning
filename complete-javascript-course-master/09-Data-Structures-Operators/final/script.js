...
let message = ' a big big bird';
console.log('big');
console.log(message.replaceAll('big', 'small'));

/*

// 1. Create an array 'events' of the different game events that happened (no duplicates)
const temp = new Set(gameEvents.values());
const events = [...temp];
console.log(events);
// 2. After the game has finished, is was found that the yellow card from minute 64 was unfair.
//  So remove this event from the game events log.
...
// 3. Print the following string to the console: "An event happened, on average, every 9 minutes"
// (keep in mind that a game has 90 minutes)
const average = 90 / [...gameEvents].length;
...
for (const [key, value] of gameEvents) {
  if (key <= 45) flag = '[FIRST HALF]';
  else flag = '[SECOND HALF]';
...
// // (We already studied how to calculate averages, you can go check if you don't remember)
// let sum = 0;
// let len = Object.values(game.odds).length;
...
//   let name = 0;
//   name = teamname === 'x' ? 'draw' : game[teamname];
...
// const namesets = new Set(playername);
// console.log(namesets);
// let sco1;
// for (const name of namesets) {
//   sco1 = 0;
//   for (let i = 0; i < playername.length; i++) {
//     if (name === playername[i]) sco1++;
//   }
//   scorers[name] = sco1;
// }
...
// // const players1 = game1.players[0];
// // const players2 = game1.players[1];
...
//   const player = allPlayers[num];
//   let sco = 0;
//   for (const i of game1.scored) {
//     if (i === player) sco++;
//   }
//   console.log(player, sco);
//   return sco;
// }

// const num = Math.trunc(Math.random() * 22);
// console.log(num);
// printGoals(num);
