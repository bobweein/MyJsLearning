...
//   if (markBMI > johnBMI)
//     console.log(
//       `Mark Miller's BMI (${markBMI}) is higher than Mark Miller's (${johnBMI})!`
//     );
...
//   else
//     console.log(
//       `John Smith's BMI (${johnBMI}) is the same as Mark Miller's (${markBMI})!`
//     );
// }

// compare(mark.calcBMI(), john.calcBMI());
